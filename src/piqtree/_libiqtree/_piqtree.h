 ...
 * content of the log file tree -- the NEWICK tree string subst_model -- the
 * substitution model name seed -- the random seed partition_info -- partition
 * information partition_type -- partition type is either ‘equal’, ‘proportion’,
 * or ‘unlinked’ seq_length -- the length of sequences insertion_rate -- the
 ...
 * size distribution population_size -- the population size
 */
extern "C" StringResult simulate_alignment(
    const char* tree,
